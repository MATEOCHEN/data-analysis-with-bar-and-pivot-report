...
plt.bar(x_index2, df3["相同性別終止結婚對數"].array
        , color="blue", label="男離婚對數", width=bar_width)
plt.bar(x_index1, df2["相同性別終止結婚對數"].array, bottom=df3["相同性別終止結婚對數"].array
        , color="red", label="女離婚對數", width=bar_width)

plt.xticks(size=8)
plt.legend()
plt.rcParams['font.sans-serif'] = ['Microsoft JhengHei']
plt.title("110年2月高雄各區同性離婚對數堆疊直線圖")
plt.xlabel('高雄各區')
plt.ylabel('離婚對數')
plt.show()
